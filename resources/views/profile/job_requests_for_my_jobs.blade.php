...
<div class="container mt-4">
    <h1 class="mb-4 text-2xl font-semibold text-gray-200">Заявки на мої вакансії</h1>
    ...
    <div class="bg-[#23272f] rounded shadow p-6">
                        ...
                        @foreach($jobRequests as $request)
                            <tr>
                                ...
                                <td class="text-center">
                                    @if($status === 'pending')
                                        <form action="{{ route('job_requests.confirm', $request->id) }}" method="POST" class="d-inline">
                                            @csrf
        ...
        @else
            <div class="text-gray-400">Поки що немає заявок на ваші вакансії.</div>
        @endif
    </div>
</div>
@endsection
